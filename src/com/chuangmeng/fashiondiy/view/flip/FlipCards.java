...
import com.chuangmeng.fashiondiy.view.flip.AphidLog;
import com.chuangmeng.fashiondiy.view.flip.TextureUtils;
import com.chuangmeng.fashiondiy.view.flip.UI;
  ...
  public void reloadTexture(int frontIndex, View frontView, int backIndex, View backView) {
    synchronized (this) {
      ...
      if (AphidLog.ENABLE_DEBUG) {
        AphidLog.d("reloading texture: %s and %s; old views: %s, %s, front changed %s, back changed %s",
